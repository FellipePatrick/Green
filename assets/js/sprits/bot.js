...
export class Bot { 
    constructor(ctx,bos){
        ...
        this.xBot = 0;
        this.showBotFrames = new ShowBot(ctx,this,this.botCut,bos); //
    ...
    stopDown = () =>  {this.showBotFrames.drawFrame(0, true,true,false);}
    stopRight = () =>  {this.showBotFrames.drawFrame(160,true,false,false);}
    stopLeft = () =>  {this.showBotFrames.drawFrame(460, true,false,false);}
    stopUp = () => {this.showBotFrames.drawFrame(320,true,true,true, 300);}
