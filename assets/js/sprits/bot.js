...
export class Bot { 
    ...
    stopDown = () =>  {if(!this.timer.getIsEnd()) this.showBotFrames.drawFrame(0, true,true,false);}
    stopRight = () =>  {if(!this.timer.getIsEnd()) this.showBotFrames.drawFrame(160,true,false,false);}
    stopLeft = () =>  {if(!this.timer.getIsEnd()) this.showBotFrames.drawFrame(460, true,false,false);}
    stopUp = () => {if(!this.timer.getIsEnd()) this.showBotFrames.drawFrame(320,true,true,true, 300);}
