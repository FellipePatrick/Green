...
export class ShowPlant{
    ...
    showerPlants = () => { //plant one grove
        if(this.bot.flagList[0]){
            ...
            this.setCoord(this.bot.getXBot()+100, this.bot.getYBot());
            ...
            this.setCoord(this.bot.getXBot(), this.bot.getYBot()+100);
        }else if(this.bot.flagList[3]){
            this.ctx.drawImage(this.images.getImgGrove(), 20, 20, 100, 100, this.bot.getXBot(),  this.bot.getYBot()-100, 130, 120, 120);
            this.setCoord(this.bot.getXBot(), this.bot.getYBot()-100);
        }
    }
